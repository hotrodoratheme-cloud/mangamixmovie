-- ============================================================
-- Chạy file NÀY nếu bạn ĐÃ CÓ bảng watch_history từ trước
-- (không cần đụng lại bảng lịch sử — tránh lỗi policy trùng)
-- Supabase → SQL Editor → Run toàn bộ
-- ============================================================
...
-- Đồng bộ user auth.users → profiles
